        ...
        <div className='flex flex-col p-2 mt-3'>
          {
            homeSideMenu.map(item => (
              <Link key={item.name} href={item.link} className='w-full p-2 flex items-center justify-normal gap-5 font-bold bg-gray-100 border-r-2 border-r-orange-600 mb-3 text-[#00000082] cursor-pointer'>
                {item.icon()}
                {item.name}
              </Link>
            ))
